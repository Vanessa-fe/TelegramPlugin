...
let StripeWebhookController = class StripeWebhookController {
    ...
    async handleEvent(signature, request) {
        if (!signature) {
            throw new common_1.BadRequestException('Stripe signature header missing');
        }
...
], StripeWebhookController.prototype, "handleEvent", null);
