...
export declare class StripeWebhookService {
    ...
    constructor(config: ConfigService, prisma: PrismaService, channelAccessService: ChannelAccessService, auditLogService: AuditLogService, metricsService: MetricsService);
