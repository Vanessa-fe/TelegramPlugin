...
import { WhatsAppConnectWizard } from "@/components/channels/whatsapp-connect-wizard";
...
type ProviderType = "telegram" | "discord" | "whatsapp" | null;
    ...
    return (
      <div className="mx-auto max-w-2xl space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold">{t("new.whatsappTitle")}</h1>
            <p className="mt-2 text-gray-600">{t("new.whatsappSubtitle")}</p>
          </div>
        </div>
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card
          className="p-6 cursor-pointer transition-all hover:border-[#25D366] hover:shadow-md"
